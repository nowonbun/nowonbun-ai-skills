...
description: 사용자가 Claude MCP 교차 검토를 명시적으로 요청한 경우 에이전트는 이 런타임 스킬을 사용하여 요청 근거, 적용 가능성, 로컬 사전 검사를 확인한 후 Claude 교차 검토 프로토콜로 넘겨야 합니다.
---
...
8. 실행을 `../tool-usage-management_claude-cross-review-protocol/SKILL.md`로 인계합니다.

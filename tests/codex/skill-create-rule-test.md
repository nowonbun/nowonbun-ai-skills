...
- skill-create-rule은 대상 SKILL.md의 frontmatter name과 일치한다.
...
5. Given 본문에는 `# Must`, `# Must NOT`, and `# Definition of Done`이 반드시 포함되어야 합니다. When 해당 규칙의 적용 조건이 충족된다. Then 대상 스킬은 해당 행동을 위반하지 않는다.

## Verification Command
~~~powershell
$target = Resolve-Path 'D:/work/nowonbun-ai-skills/codex-skills/skill-management_skill-create-rule/SKILL.md'
$test = Resolve-Path 'D:/work/nowonbun-ai-skills/tests/skill-create-rule-test.md'
